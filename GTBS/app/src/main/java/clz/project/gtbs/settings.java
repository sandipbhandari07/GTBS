...
public class settings extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo()
    {
        ...
        ref.child(feature.currentonlineUser.getPhone()).updateChildren(userMap);
    ...
    private void uploadImage()
    {
        ...
        if (imageUri != null)
        {
            final StorageReference fileRef = storageProfilePrictureRef
                    .child(feature.currentonlineUser.getPhone() + ".jpg");
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child(feature.currentonlineUser.getPhone());
