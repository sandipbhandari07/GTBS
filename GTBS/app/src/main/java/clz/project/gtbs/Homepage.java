...
import clz.project.gtbs.ProductViewHolder.ProductViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               Intent intent = new Intent(Homepage.this,CartAct.class);
      ...
      userNameTextView.setText(feature.currentonlineUser.getName());
        Picasso.get().load(feature.currentonlineUser.getImage()).placeholder(R.drawable.profile).into(profileimageview);
